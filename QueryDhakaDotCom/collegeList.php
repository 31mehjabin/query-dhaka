...
<style>
                     ...
                     html{
                           background:url('query15.jpg') no-repeat center fixed;
        ...
        <secO>
                   ...
                   <partOne style="float:left;">
                               <ul class="mainmenu">
                                   ...
                                   <li style="width:230px;"><a href="hospitalList.php">Hotels</a></li>
                                   <li style="width:230px;"><a href="RestaurantList.php">Restaurants</a></li>
                                   <li style="width:230px;"><a href="">Educational Institute</a>
                                          <ul class="submenu">
                ...
                <partTwo>
                      ...
                      <?php
                         ...
                         echo "<tr><td>".$row["Name"]."</td><td>".$row["Address"]."</td><td>".$row["Phone No."]."</td></tr>";
                         }
