       ...
       <div class="background-wrap">
        ...
        <secO>
                ...
                <partTwo>
                      ...
                      <tr><th>Name</th><th>Address</th><th>Contact No of OC</th><th>Contact of Duty Officer</th></tr>
                 ...
                 echo "<tr><td>".$row["Police Station"]."</td><td>".$row["Address"]."</td><td>".$row["Contact No of OC"]."</td><td>".$row["Contact No of Duty Officer"]."</td></tr>";
                         }
